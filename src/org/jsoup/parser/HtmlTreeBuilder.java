...
public class HtmlTreeBuilder extends TreeBuilder {
    ...
    public static final String[] TagsSearchInScope = new String[] { "applet", "caption", "html", "table", "td", "th",
            "marquee", "object" };
    ...
    private static final String[] TagSearchEndTags = new String[] { "dd", "dt", "li", "option", "optgroup", "p", "rp",
            "rt" };
    private static final String[] TagSearchSpecial = new String[] { "address", "applet", "area", "article", "aside",
            "base", "basefont", "bgsound", "blockquote", "body", "br", "button", "caption", "center", "col", "colgroup",
    ...
    private ArrayList<Element> formattingElements = new ArrayList<Element>(); // active
                                                                              // (open)
                                                                              // formatting
                                                                              // elements
    ...
    Element insert(Token.StartTag startTag) {
        ...
        if (startTag.isSelfClosing()) {
            ...
            tokeniser.transition(TokeniserState.Data); // handles <script />,
                                                       ...
                                                       // breakout steps from
                                                       // script data
            tokeniser.emit(emptyEnd.reset().name(el.tagName())); // ensure we
                                                                 // get out of
                                                                 // whatever
                                                                 // state we are
                                                                 // in. emitted
    ...
    void reconstructFormattingElements() {
        ...
        while (true) {
            ...
            Element newEl = insertStartTag(entry.nodeName()); // todo: avoid
                                                              // fostering here?
