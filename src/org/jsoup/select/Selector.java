 ...
 * <td>pseudo-class notation represents an element that has <code><em>a</em>n+
 * <em>b</em>-1</code> siblings with the same expanded element name
 * <em>before</em> it in the document tree, for any zero or positive integer
 ...
 * <td>pseudo-class notation represents an element that has <code><em>a</em>n+
 * <em>b</em>-1</code> siblings with the same expanded element name
 * <em>after</em> it in the document tree, for any zero or positive integer
 * value of n, and has a parent element</td>
