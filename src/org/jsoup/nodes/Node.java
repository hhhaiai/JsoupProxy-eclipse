...
public abstract class Node implements Cloneable {
    ...
    /**
     * Check if this node is equal to another node. A node is considered equal
     * if its attributes and content equal the other node; particularly its
     * position in the tree does not influence its equality.
     * 
     * @param o
     ...
     * attributes, and recursing into any child nodes. This means that a node's
     * hashcode is based on it and its child content, and not its parent or
     * place in the tree. So two nodes with the same content, regardless of
     * their position in the tree, will have the same hashcode.
     * 
